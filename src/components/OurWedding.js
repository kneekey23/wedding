                    ...
                    <div className="container">
                        ...
                        <div className="row">
                            <div className="col-sm-4 text-center">
                                <div className="block-event">
                                    ...
                                    <p >Main Beach<span>1500 Orange Ave, Coronado, CA 92118</span></p>
                                </div>
                            </div>
                            <div className="col-sm-4 text-center">
                                <div className="block-event swap">
                                    ...
                                    <p className="mt-30 mb-30">Cocktails<span>After Ceremony</span></p>
                                    <p >Main Beach<span>Join us for celebratory cocktails on the sand!!</span></p>
                                </div>
                            </div>
                            <div className="col-sm-4 text-center">
                                <div className="block-event">
                        ...
                        <div className="row">
                            <div className="col-sm-8 col-sm-offset-2 text-center">
                                ...
                                <p>Note on Childcare: We kindly request childcare be provided during our wedding and reception.  Please contact our Wedding Planner, Victoria Schroeder for assistance with a local, qualified caregiver in the area.  She can be reached at <a href="mailto: victoria@victoriawe.com">victoria@victoriawe.com</a> </p>
